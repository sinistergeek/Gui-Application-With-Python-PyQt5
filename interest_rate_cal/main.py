...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QPushButton, QVBoxLayout,QHBoxLayout,QTreeView,QLineEdit,QMainWindow,QFileDialog,QMessageBox,QCheckBox
...
class FinanceApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("InteresMe 2.0")
        self.resize(800,600)
    ...
    def calc_interest(self):
        ...
        try:
            ...
            inital_investment = float(self.inital_input.text())
        ...
        totals = [inital_investment * (1 + interest_rate/100)**year for year in years]
    ...
    def save_data(self):
        ...
        if dir_path:
            ...
            QMessageBox.information(self,"Save Result","Result were save to the folder")
        else:
            QMessageBox.warning(self,"Save Result","No directory selected")
